...
public class SmoothAvatarFragment extends BaseFeatureFragment {

  public static Fragment newInstance() {
    return new SmoothAvatarFragment();
  }
  ...
  public int getContentLayout() {
    return R.layout.fragment_smooth_avatar;
  }
  ...
  public void onViewCreated(View view, Bundle savedInstanceState) {
    ...
    vTitle.setText(getActivity().getTitle());
