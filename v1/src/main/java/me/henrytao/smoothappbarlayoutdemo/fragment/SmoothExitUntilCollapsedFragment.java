...
public class SmoothExitUntilCollapsedFragment extends BaseFeatureFragment {

  public static Fragment newInstance() {
    return new SmoothExitUntilCollapsedFragment();
  }
  ...
  public int getContentLayout() {
    return R.layout.fragment_smooth_exit_until_collapsed;
  }
