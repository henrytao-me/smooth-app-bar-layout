...
public class GsdExitUntilCollapsedFragment extends BaseFeatureFragment {

  public static Fragment newInstance() {
    return new GsdExitUntilCollapsedFragment();
  }
  ...
  public int getContentLayout() {
    return R.layout.fragment_gsd_exit_until_collapsed;
  }
