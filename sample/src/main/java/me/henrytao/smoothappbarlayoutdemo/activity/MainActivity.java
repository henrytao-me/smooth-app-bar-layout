...
public class MainActivity extends BaseActivity implements SimpleAdapter.OnItemClickListener<MainActivity.Feature> {
  ...
  protected List<Feature> getFeatures() {
    ...
    features.add(new Feature(GsdScrollParallaxActivity.class, "scroll | parallax"));
    features.add(new Feature(SmoothScrollParallaxActivity.class, "scroll | parallax"));
    ...
    features.add(new Feature(null, "-"));
    features.add(new Feature(SmoothPreScrollActivity.class, "PreScroll"));
    ...
    features.add(new Feature(null, "N/A"));
    features.add(new Feature(SmoothCollapsingToolbarLayoutWithViewPager.class, "CollapsingToolbarLayout with ViewPager"));
    return features;
  }
