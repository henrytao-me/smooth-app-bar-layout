...
public class GsdScrollParallaxActivity extends BaseActivity {
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    setContentView(R.layout.activity_gsd_scroll_parallax);
    ButterKnife.bind(this);

    // This is important for making activity under statusbar. It also can be done theme.
